...
async def run_async() -> int:
    ...
    tasks = [calculate_sum_async(range_start, range_end) for range_start, range_end in ranges]
...
if __name__ == "__main__":
    ...
    append_result(Path("task1_times.csv"), "async", elapsed, f"workers={WORKERS}, total={total}")
